...
public class MailServiceImpl implements MailService {
    ...
    public MailDTO createMail(String email) {
        ...
        dto.setTitle("니모내모 인증코드 안내 이메일 입니다.");
        dto.setMessage("<html><div align='center' style='border:1px solid grey; font-family:verdana; height: 200px;'><h3 style='color:grey;'>안녕하세요 니모내모입니다. 회원님의 비밀번호 재설정을 위한 인증코드를 보내드립니다.</h3><br/><br/>" + "<div style='font-size:30px'><strong>" + code + "</strong></div></div></html>");
