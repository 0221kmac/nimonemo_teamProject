        ...
        <div id="product_text_zone" className="w-1/2">
          <div className="flex justify-center">
            <div className="relative mb-4 flex w-full flex-wrap items-stretch">
              {/* <div className="w-1/4 p-4 text-right font-bold">상품명</div> */}
              {/* <div className="w-3/4 p-4 rounded-r border border-solid shadow-md"> */}
              <div className="w-full p-4 text-3xl">{product.pname}</div>
            </div>
          </div>
          <div className="flex justify-center">
            <div className="relative mb-4 flex w-full flex-wrap items-stretch">
              {/* <div className="w-1/4 p-4 text-right font-bold">가격</div> */}
              {/* <div className="w-3/4 p-4 rounded-r border border-solid shadow-md"> */}
          ...
          <div className="flex justify-center">
            <div className="relative mb-4 flex w-full flex-wrap items-stretch">
              {/* <div className="w-1/4 p-4 text-right font-bold">상품설명</div> */}
              {/* <div className="w-3/4 p-4 rounded-r border border-solid shadow-md"> */}
